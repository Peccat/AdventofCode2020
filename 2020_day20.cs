...
{
    public partial class _2020_day20 : Form
    {
        public _2020_day20()
        {
            InitializeComponent();
		...
		long part1answer = new long();
		int[] roughness = new int[8];
		private void _2020_day20_Load(object sender, EventArgs e)
        {
            btn_solv2.Visible = false;
			int line = 0;
			List<string> input = new List<string>();
			StreamReader reader = new StreamReader("2020_day20.txt");
			...
			part1answer = image[(minx, miny)].id * image[(maxx, miny)].id * image[(minx, maxy)].id * image[(maxx, maxy)].id;
        ...
        {
			lbl_part2answer.Text= roughness.Min().ToString();
		}

        private void btn_back_Click(object sender, EventArgs e)
        {
			_2020_day20 setting = new _2020_day20();
			this.Close();
			setting.Close();
        }
    }
